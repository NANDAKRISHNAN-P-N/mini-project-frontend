    ...
    //     </div>
        ...
        <form className='max-w-[400] w-96 mx-auto bg-gray-400 p-4 py-36' method='GET'>
            ...
            <div class="mb-6">
                ...
                <input className='inline-block w-full p-4 leading-6 text-lg font-bold placeholder-indigo-900 bg-white shadow border-2 border-indigo-900 rounded' type="password" onChange={handlePassword}/>
            </div>
            {/* <Link to='/YearSelect'> */}
            ...
            <div className='flex justify-between'>
                <Link to='/Forgotpass'>
                    <label className="w-full lg:w-auto px-4">
                        <a class="inline-block font-extrabold hover:underline" href="#">Forgot Password?</a>
                    </label>
                </Link>
            </div>
        </form>
